...
class InteractionsControllerTest < ActionController::TestCase
  ...
  test "should create interaction" do
    assert_difference('Interaction.count') do
      post :create, interaction: { controller_action_id: @interaction.controller_action_id, role_id: @interaction.role_id }
    end
  ...
  test "should update interaction" do
    patch :update, id: @interaction, interaction: { controller_action_id: @interaction.controller_action_id, role_id: @interaction.role_id }
    assert_redirected_to interaction_path(assigns(:interaction))
  end
